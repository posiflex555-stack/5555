// ====================== تسوية السواقين - الإصدار النهائي v2 ======================
...
function exportJSON(){
  ...
  a.download = `تسوية-سواقين-${data.date || 'backup'}.json`;
  a.click();
}
...
// حفظ تلقائي للإيراد (احتياطي)
const incomeFields = ["cashIncome","networkIncome","appsIncome","deliveryExpense","debtOne","debtTwo"];
